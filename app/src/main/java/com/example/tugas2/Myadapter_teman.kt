...
class Myadapter_teman (private val namalist:ArrayList<itemdata_teman>):RecyclerView.Adapter<Myadapter_teman.MyViewHolder>(){
 ...
 class MyViewHolder (itemdata_teman: View):RecyclerView.ViewHolder(itemdata_teman){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemdata=LayoutInflater.from(parent.context).inflate(R.layout.item_data_teman,parent,false)
